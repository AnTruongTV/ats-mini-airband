...
// Keep AVC field blinking while CMD_AVC is active
if (currentCmd == CMD_AVC && (currentTime - avcBlinkTimer) >= 500)
{
    avcBlinkTimer = currentTime;
    needRedraw = true;
}
